...
<!DOCTYPE html>
	...
	<head>
		<title>Group 6 Coursework Part 2</title>
		
		<style>
		body {background-color: #D3D3D3; position:relative; text-align:center; }
		</style>
	...
	<body>
		<h1>
			SET08803 2021-2 TR2 001 - Software Engineering Methods
		</h1>
		
		<h2>
			Coursework part 2 - <a href="https://github.com/xx00a/Group6">Group 6</a>
		</h2>
		
		<p>
		Please select report number that you would like to generate:
		</p>
		...
		<p>
		Please write a grouping you would like to use <i>(can be left blank)</i>
		</p>
